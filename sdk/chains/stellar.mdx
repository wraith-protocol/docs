...
Use [Stellar Explorer Recipes](/guides/stellar-explorer-recipes) when you need to link accounts, transactions, Soroban contracts, assets, or stealth accounts from your integration UI.
