...
|---|---|---|
| `@noble/curves` | EVM + Stellar + Solana chains | Elliptic curve operations |
| `@noble/hashes` | EVM + Stellar + Solana chains | SHA-256, SHA-512, keccak256 |
...
`@stellar/stellar-sdk` and `@solana/web3.js` are optional peer dependencies. They're only needed if you import their respective chain modules.
