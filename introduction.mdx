...
- [Spectre + Stellar Cookbook](guides/spectre-stellar-cookbook) — three production recipes: SaaS payments, DAO payroll, privacy monitoring
- [Stellar Federation Addresses](guides/stellar-federation) — resolve `alice*example.com` addresses, caching, UX patterns, failure modes
