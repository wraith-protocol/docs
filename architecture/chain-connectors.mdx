...
| `registerName` | Not implemented initially |
| `resolveName` | Not implemented initially |
...
- **No names initially:** `.wraith` name registration requires a Type Script — deferred to a future release.
