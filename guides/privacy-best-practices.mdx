...
description: "Scoring, timing patterns, and address hygiene"
keywords:
  [
    "privacy",
    "privacy score",
    ...
    "address correlation",
    "unlinkable",
    "stealth address best practices",
    "metadata",
  ]
---
...
Stealth addresses are one-time by design. The Wraith protocol enforces this — each payment generates a fresh address automatically. If you're building custom integrations with the [EVM crypto primitives](/sdk/chains/evm), call `generateStealthAddress()` for each payment.
