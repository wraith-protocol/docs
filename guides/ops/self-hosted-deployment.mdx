...
For production deployments, see the [Monitoring, Alerting, and On‑Call Runbook](/guides/ops/monitoring-and-on-call) to set up:
- Grafana dashboards for RPC, indexer, and contract health
- Prometheus alerting rules with severity thresholds
- Incident response playbooks for common operational issues
- Quarterly tabletop exercises to validate readiness
